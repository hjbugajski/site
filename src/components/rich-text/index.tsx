...
import { ItemBlock } from '@/components/blocks/item';
...
type NodeType =
  | DefaultNodeTypes
  | SerializedBlockNode<PayloadItemBlock | PayloadSectionBlock>
  | SerializedInlineBlockNode;
...
function convertLexicalToJsx({
  ...
  return nodes.map<ReactNode>((node, i) => {
    ...
    let converter: JSXConverter<NodeType> | undefined;
...
export function RichText({ content, overrideClasses }: Props) {
